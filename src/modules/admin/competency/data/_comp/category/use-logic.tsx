...
const Index = (props?: any) => {
    ...
    const addData = async (addPayload: any) => {
        ...
        try {
            const response = await axios.post('/api/service/competency/category/save', addPayload, {
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    const updateData = async (updatePayload: any, id: string) => {
        ...
        try {
            const response = await axios.patch(`/api/service/competency/category/update/${id}`, updatePayload, {
                headers: {
                    'Content-Type': 'application/json'
                },
                withCredentials: true
    ...
    const deleteData = async (id: string) => {
        ...
        try {
            const response = await axios.delete(`/api/service/competency/category/delete/${id}`, {
                headers: {
                    'Content-Type': 'application/json'
                },
                withCredentials: true
