...
const Index = (props?: any) => {
    ...
    const addData = async (addPayload: any) => {
        ...
        try {
            const response = await axios.post('/api/service/proficiency/save', addPayload, {
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    const updateData = async (updatePayload: any, id: string) => {
        ...
        try {
            const response = await axios.patch(`/api/service/proficiency/update/${id}`, updatePayload, {
                headers: {
                    'Content-Type': 'application/json'
                },
                withCredentials: true
    ...
    const deleteData = async (id: string) => {
        ...
        try {
            const response = await axios.delete(`/api/service/proficiency/delete/${id}`, {
                headers: {
                    'Content-Type': 'application/json'
                },
                withCredentials: true
