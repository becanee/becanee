import { analyzeTask } from "@/core/analyze/task";
import { analyzeTaskFeedback } from "@/core/analyze/task-feedback";
...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        return NextResponse.json({
            ...
            httpCode: 200,
            powered_by: process.env.NEXT_PUBLIC_COMPANY,
            data: type === "task" ? await analyzeTask(payload) :
                type === "task-feedback" ? await analyzeTaskFeedback(payload) : null
        });
